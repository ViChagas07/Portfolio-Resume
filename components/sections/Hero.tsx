...
export function Hero() {
  ...
  return (
    ...
    >
      {/* AD Monogram Crest */}
      <div
        className="relative mb-10 flex h-52 w-52 items-center justify-center md:h-60 md:w-60"
        aria-label="Alisson Davi logo"
      >
        {/* Radar ring — outer blue pulsing */}
        <div
          className="absolute inset-[-10px] animate-radar rounded-full border-2 border-[var(--color-blue)]/70 shadow-[0_0_30px_var(--color-blue-glow)]"
          aria-hidden="true"
        />
        {/* Middle red ring */}
        <div
